...
TTT1(){
super("Tic Tac Toe Game by Umme");
...
ic1=new ImageIcon("cross.jpg");
ic2=new ImageIcon("zero.jpg");
ic11=new ImageIcon("cross1.jpg");
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();
	...
	JOptionPane.showMessageDialog(TTT1.this,"!!!YOU won!!! click reset");			 break;
             ...
             b[(a[i][3]-1)].setIcon(ic22); 
               JOptionPane.showMessageDialog(TTT1.this,"!!!ARGH (COMPUTER) won!!! click reset");
                break;			 
               }
         }
    }  
